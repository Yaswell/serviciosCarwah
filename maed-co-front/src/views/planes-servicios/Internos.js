...
const url= 'http://localhost:3001/inside_services';
          ...
          .then(response=>{
            ...
            dataNueva.map(cliente => {
              if(cliente.id ===this.state.data.id) {
                ...
                cliente.hidTableroPaneles = this.state.data.hidTableroPaneles;
    ...
    return (
        <div>
            ...
            <tr>
                ...
                <th>Hidratacion de Tablero Paneles</th>
                <th>Limpieza interior</th>
                <th>Ozono</th>
                <th>Hidratacion Leather / Vynil</th>
                <th>Lavado de motor</th>
        ...
        <tr key={lavador.id} id={lavador.id}>
            ...
            <td>{lavador.ozono}</td>
            <td>{lavador.hidLeatherVynil}</td>
            <td>{lavador.lavadoMotor}</td>
